...
### Os requisitos
OK Crie os processos e os documente, justificando a importância de cada atividade.
OK Determine as tecnologias, sistemas, softwares e quaisquer elementos que considere importantes para o processo de garantia da qualidade na XY Sistemas.
OK Determine os papéis a serem desempenhados para o processo que você está propondo.
...
### Premissas
1. A XY sistemas desenvolve ERPs
1. Workflow de um desenvolvimento: TO DO > IN DEV > IN TEST > DONE
...
Para pautar os desenvolvimentos e os testes, utilizaremos dois tipos de _framework_: TDD e BDD. O TDD (_Test Driven Development_)será utilizado para garantir qualidade no nível unitário e será responsabilidade do desenvolvedor. O BDD (_Business Driven Development_) será utilizado para garantir qualidade em nível integrado e sua execução será de responsabilidade do QA.
...
O proprietário do produto tem a visão do produto e traz requisitos baseados no negócio e qualidade. Desenvolvedores estimam a complexidade do trabalho e delimitam o tempo necessário para desenvolver, onde executam, resolvem problemas e garante a entrega. Qualidade e testes avaliam se o Sistema criado corresponde à visão de negócio e qualidade trazidos pelo proprietário, para então disponibilizar o aplicativo.
